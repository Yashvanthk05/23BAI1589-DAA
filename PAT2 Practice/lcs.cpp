...
int LCSTabu(string x,string y,int n,int m){
...
int main(){
  ...
  cout<<"LCS Recursion: "<<LCSRecur(x,y,n,m)<<endl;
  vector<vector<int>> dp(n+1,vector<int>(m+1,-1));
  cout<<"LCS Memoization: "<<LCSMemo(x,y,n,m,dp)<<endl;
  cout<<LCSString(x,y,n,m,dp)<<endl;
  cout<<"LCS Tabulation: "<<LCSTabu(x,y,n,m)<<endl;
  return 0;
}